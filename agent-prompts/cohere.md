# Cohere -- Agent Prompt Guide

Self-contained reference for generating pixel-perfect Cohere-branded components.
Aesthetic: AI platform with coral warmth.
...
Create a hero section with Cohere visual identity:
- Background: `#ffffff` (light clean surface)
- Container: max-width 1200px, centered, padding 120px 64px
- Headline: 48px, weight 600, line-height 1.15, color `#171717`
- Subtitle: 20px, weight 400, line-height 1.50, color `#6b6b6b`, max-width 600px, margin-top 16px
- CTA button: background `#d18ee2`, color `#ffffff`, 16px weight 500, padding 12px 24px, border-radius 8px
- On mobile (<640px): headline 32px, padding 48px 20px

### Feature Card

Create a feature card with Cohere visual identity:
- Background: `#ffffff`
- Border-radius: 8px
- Padding: 32px
- Title: 24px, weight 600, line-height 1.20, color `#171717`
- Description: 16px, weight 400, line-height 1.50, color `#6b6b6b`
- On mobile (<640px): padding 24px, title 20px

### CTA Button Row

Create a CTA button row with Cohere visual identity:
- Layout: flex, gap 12px
- Primary: background `#d18ee2`, color `#ffffff`, padding 12px 24px, border-radius 8px
- Secondary: background transparent, border 1px solid `#d18ee2`, color `#d18ee2`, padding 12px 24px, border-radius 8px
- On mobile (<640px): stack full-width

### Navigation Bar

Create a navigation bar with Cohere visual identity:
- Background: `#ffffff`, position sticky, top 0
- Height: 64px, max-width 1200px, centered
- Logo: brand mark, color `#171717`
- Nav links: 14px weight 500, color `#6b6b6b`
- CTA button (right): background `#d18ee2`, color white

### Data Card / Metric Display

Create a metric card with Cohere visual identity:
- Background: `#ffffff`
- Border-radius: 8px, padding 32px
- Metric: 32px weight 600, color `#171717`
- Label: 14px weight 400, color `#6b6b6b`

### Brand-Specific Component

Create a component showcasing Cohere's distinctive design pattern:
- Reflect the brand's coral-accent characteristic
- Use accent color `#d18ee2` sparingly for high-signal moments
...
2. **Accent color is for high-signal moments only.** `#d18ee2` appears on CTAs and key interactive elements. Never use it as a decorative surface fill.
...
6. **Every component should feel unmistakably Cohere.** The coral-accent aesthetic is the brand's signature.
