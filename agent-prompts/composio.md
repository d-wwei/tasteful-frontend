# Composio -- Agent Prompt Guide

Self-contained reference for generating pixel-perfect Composio-branded components.
Aesthetic: AI integration with purple tech accent.
...
Create a hero section with Composio visual identity:
...
Create a feature card with Composio visual identity:
- Background: `#ffffff`
- Border-radius: 8px
- Padding: 32px
...
Create a CTA button row with Composio visual identity:
...
Create a navigation bar with Composio visual identity:
...
Create a metric card with Composio visual identity:
- Background: `#ffffff`
...
Create a component showcasing Composio's distinctive design pattern:
- Reflect the brand's purple-tech characteristic
...
6. **Every component should feel unmistakably Composio.** The purple-tech aesthetic is the brand's signature.
