...
Aesthetic: dark ride-share with monochromatic precision.
...
- Subtitle: 20px, weight 400, line-height 1.50, color `#afafaf`, max-width 600px, margin-top 16px
...
- Description: 16px, weight 400, line-height 1.50, color `#afafaf`
...
- Nav links: 14px weight 500, color `#afafaf`
- CTA button (right): background `#ffffff`, color white

### Data Card / Metric Display

Create a metric card with Uber visual identity:
- Background: `#1a1a1a`
- Border-radius: 8px, padding 32px
- Metric: 32px weight 600, color `#ffffff`
- Label: 14px weight 400, color `#afafaf`

### Brand-Specific Component

Create a component showcasing Uber's distinctive design pattern:
- Reflect the brand's dark-minimalism characteristic
...
6. **Every component should feel unmistakably Uber.** The dark-minimalism aesthetic is the brand's signature.
