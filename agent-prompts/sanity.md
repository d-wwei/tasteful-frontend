# Sanity -- Agent Prompt Guide

Self-contained reference for generating pixel-perfect Sanity-branded components.
Aesthetic: content platform with red brand energy.
...
Create a hero section with Sanity visual identity:
- Background: `#ffffff` (light clean surface)
- Container: max-width 1200px, centered, padding 120px 64px
- Headline: 48px, weight 600, line-height 1.15, color `#101112`
- Subtitle: 20px, weight 400, line-height 1.50, color `#6b7280`, max-width 600px, margin-top 16px
- CTA button: background `#f03e2f`, color `#ffffff`, 16px weight 500, padding 12px 24px, border-radius 8px
- On mobile (<640px): headline 32px, padding 48px 20px

### Feature Card

Create a feature card with Sanity visual identity:
- Background: `#ffffff`
- Border-radius: 8px
- Padding: 32px
- Title: 24px, weight 600, line-height 1.20, color `#101112`
- Description: 16px, weight 400, line-height 1.50, color `#6b7280`
- On mobile (<640px): padding 24px, title 20px

### CTA Button Row

Create a CTA button row with Sanity visual identity:
- Layout: flex, gap 12px
- Primary: background `#f03e2f`, color `#ffffff`, padding 12px 24px, border-radius 8px
- Secondary: background transparent, border 1px solid `#f03e2f`, color `#f03e2f`, padding 12px 24px, border-radius 8px
- On mobile (<640px): stack full-width

### Navigation Bar

Create a navigation bar with Sanity visual identity:
- Background: `#ffffff`, position sticky, top 0
- Height: 64px, max-width 1200px, centered
- Logo: brand mark, color `#101112`
- Nav links: 14px weight 500, color `#6b7280`
- CTA button (right): background `#f03e2f`, color white

### Data Card / Metric Display

Create a metric card with Sanity visual identity:
- Background: `#ffffff`
- Border-radius: 8px, padding 32px
- Metric: 32px weight 600, color `#101112`
- Label: 14px weight 400, color `#6b7280`

### Brand-Specific Component

Create a component showcasing Sanity's distinctive design pattern:
- Reflect the brand's red-brand characteristic
- Use accent color `#f03e2f` sparingly for high-signal moments
...
2. **Accent color is for high-signal moments only.** `#f03e2f` appears on CTAs and key interactive elements. Never use it as a decorative surface fill.
...
6. **Every component should feel unmistakably Sanity.** The red-brand aesthetic is the brand's signature.
