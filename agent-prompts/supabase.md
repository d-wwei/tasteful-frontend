...
Aesthetic: dark developer platform with green accents.
...
- Background: `#1c1c1c` (dark immersive surface)
- Container: max-width 1200px, centered, padding 120px 64px
- Headline: 48px, weight 600, line-height 1.15, color `#ffffff`
- Subtitle: 20px, weight 400, line-height 1.50, color `#8f8f8f`, max-width 600px, margin-top 16px
- CTA button: background `#3ecf8e`, color `#000000`, 16px weight 500, padding 12px 24px, border-radius 8px
...
- Description: 16px, weight 400, line-height 1.50, color `#8f8f8f`
...
- Primary: background `#3ecf8e`, color `#000000`, padding 12px 24px, border-radius 8px
- Secondary: background transparent, border 1px solid `#3ecf8e`, color `#3ecf8e`, padding 12px 24px, border-radius 8px
- On mobile (<640px): stack full-width

### Navigation Bar

Create a navigation bar with Supabase visual identity:
- Background: `#1c1c1c`, position sticky, top 0
- Height: 64px, max-width 1200px, centered
- Logo: brand mark, color `#ffffff`
- Nav links: 14px weight 500, color `#8f8f8f`
- CTA button (right): background `#3ecf8e`, color white

### Data Card / Metric Display

Create a metric card with Supabase visual identity:
- Background: `#1a1a1a`
- Border-radius: 8px, padding 32px
- Metric: 32px weight 600, color `#ffffff`
- Label: 14px weight 400, color `#8f8f8f`

### Brand-Specific Component

Create a component showcasing Supabase's distinctive design pattern:
- Reflect the brand's dark-dev-platform characteristic
- Use accent color `#3ecf8e` sparingly for high-signal moments
...
2. **Accent color is for high-signal moments only.** `#3ecf8e` appears on CTAs and key interactive elements. Never use it as a decorative surface fill.
...
6. **Every component should feel unmistakably Supabase.** The dark-dev-platform aesthetic is the brand's signature.
