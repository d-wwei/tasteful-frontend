# Hashicorp -- Agent Prompt Guide

Self-contained reference for generating pixel-perfect Hashicorp-branded components.
Aesthetic: infrastructure with black and white precision.
...
Create a hero section with Hashicorp visual identity:
...
Create a feature card with Hashicorp visual identity:
- Background: `#ffffff`
- Border-radius: 8px
- Padding: 32px
...
Create a CTA button row with Hashicorp visual identity:
...
Create a navigation bar with Hashicorp visual identity:
...
Create a metric card with Hashicorp visual identity:
- Background: `#ffffff`
...
Create a component showcasing Hashicorp's distinctive design pattern:
- Reflect the brand's infra-precision characteristic
...
6. **Every component should feel unmistakably Hashicorp.** The infra-precision aesthetic is the brand's signature.
