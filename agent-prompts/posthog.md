...
Aesthetic: quirky product analytics with hedgehog personality.
...
- Headline: 48px, weight 600, line-height 1.15, color `#151515`
- Subtitle: 20px, weight 400, line-height 1.50, color `#7a7a7a`, max-width 600px, margin-top 16px
- CTA button: background `#f54e00`, color `#ffffff`, 16px weight 500, padding 12px 24px, border-radius 8px
...
- Border-radius: 8px
- Padding: 32px
- Title: 24px, weight 600, line-height 1.20, color `#151515`
- Description: 16px, weight 400, line-height 1.50, color `#7a7a7a`
...
- Primary: background `#f54e00`, color `#ffffff`, padding 12px 24px, border-radius 8px
- Secondary: background transparent, border 1px solid `#f54e00`, color `#f54e00`, padding 12px 24px, border-radius 8px
...
- Logo: brand mark, color `#151515`
- Nav links: 14px weight 500, color `#7a7a7a`
- CTA button (right): background `#f54e00`, color white

### Data Card / Metric Display

Create a metric card with Posthog visual identity:
- Background: `#ffffff`
- Border-radius: 8px, padding 32px
- Metric: 32px weight 600, color `#151515`
- Label: 14px weight 400, color `#7a7a7a`

### Brand-Specific Component

Create a component showcasing Posthog's distinctive design pattern:
- Reflect the brand's quirky-brand characteristic
- Use accent color `#f54e00` sparingly for high-signal moments
...
2. **Accent color is for high-signal moments only.** `#f54e00` appears on CTAs and key interactive elements. Never use it as a decorative surface fill.
...
6. **Every component should feel unmistakably Posthog.** The quirky-brand aesthetic is the brand's signature.
