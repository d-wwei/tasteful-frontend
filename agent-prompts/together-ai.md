# Together Ai -- Agent Prompt Guide

Self-contained reference for generating pixel-perfect Together Ai-branded components.
Aesthetic: AI infrastructure with blue tech accent.
...
Create a hero section with Together Ai visual identity:
...
- CTA button: background `#2563eb`, color `#ffffff`, 16px weight 500, padding 12px 24px, border-radius 8px
- On mobile (<640px): headline 32px, padding 48px 20px

### Feature Card

Create a feature card with Together Ai visual identity:
- Background: `#ffffff`
- Border-radius: 8px
- Padding: 32px
...
Create a CTA button row with Together Ai visual identity:
- Layout: flex, gap 12px
- Primary: background `#2563eb`, color `#ffffff`, padding 12px 24px, border-radius 8px
- Secondary: background transparent, border 1px solid `#2563eb`, color `#2563eb`, padding 12px 24px, border-radius 8px
- On mobile (<640px): stack full-width

### Navigation Bar

Create a navigation bar with Together Ai visual identity:
...
- CTA button (right): background `#2563eb`, color white

### Data Card / Metric Display

Create a metric card with Together Ai visual identity:
- Background: `#ffffff`
...
Create a component showcasing Together Ai's distinctive design pattern:
- Reflect the brand's blue-tech characteristic
- Use accent color `#2563eb` sparingly for high-signal moments
...
2. **Accent color is for high-signal moments only.** `#2563eb` appears on CTAs and key interactive elements. Never use it as a decorative surface fill.
...
6. **Every component should feel unmistakably Together Ai.** The blue-tech aesthetic is the brand's signature.
