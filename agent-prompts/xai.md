# Xai -- Agent Prompt Guide

Self-contained reference for generating pixel-perfect Xai-branded components.
Aesthetic: AI research with minimal dark interface.
...
Create a hero section with Xai visual identity:
...
Create a feature card with Xai visual identity:
- Background: `#1a1a1a`
- Border-radius: 8px
- Padding: 32px
...
Create a CTA button row with Xai visual identity:
...
Create a navigation bar with Xai visual identity:
...
Create a metric card with Xai visual identity:
- Background: `#1a1a1a`
...
Create a component showcasing Xai's distinctive design pattern:
- Reflect the brand's minimal-dark characteristic
...
6. **Every component should feel unmistakably Xai.** The minimal-dark aesthetic is the brand's signature.
