...
Aesthetic: designer-first with blue CTA precision.
...
- CTA button: background `#4353ff`, color `#ffffff`, 16px weight 500, padding 12px 24px, border-radius 8px
...
- Primary: background `#4353ff`, color `#ffffff`, padding 12px 24px, border-radius 8px
- Secondary: background transparent, border 1px solid `#4353ff`, color `#4353ff`, padding 12px 24px, border-radius 8px
...
- CTA button (right): background `#4353ff`, color white

### Data Card / Metric Display

Create a metric card with Webflow visual identity:
- Background: `#ffffff`
...
Create a component showcasing Webflow's distinctive design pattern:
- Reflect the brand's designer-first characteristic
- Use accent color `#4353ff` sparingly for high-signal moments
...
2. **Accent color is for high-signal moments only.** `#4353ff` appears on CTAs and key interactive elements. Never use it as a decorative surface fill.
...
6. **Every component should feel unmistakably Webflow.** The designer-first aesthetic is the brand's signature.
