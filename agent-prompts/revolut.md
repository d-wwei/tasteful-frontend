...
Aesthetic: dark fintech with gradient energy.
...
- Background: `#0c0c0e` (dark immersive surface)
- Container: max-width 1200px, centered, padding 120px 64px
- Headline: 48px, weight 600, line-height 1.15, color `#ffffff`
- Subtitle: 20px, weight 400, line-height 1.50, color `#8b8b8f`, max-width 600px, margin-top 16px
- CTA button: background `#0666eb`, color `#000000`, 16px weight 500, padding 12px 24px, border-radius 8px
...
- Description: 16px, weight 400, line-height 1.50, color `#8b8b8f`
...
- Primary: background `#0666eb`, color `#000000`, padding 12px 24px, border-radius 8px
- Secondary: background transparent, border 1px solid `#0666eb`, color `#0666eb`, padding 12px 24px, border-radius 8px
- On mobile (<640px): stack full-width

### Navigation Bar

Create a navigation bar with Revolut visual identity:
- Background: `#0c0c0e`, position sticky, top 0
- Height: 64px, max-width 1200px, centered
- Logo: brand mark, color `#ffffff`
- Nav links: 14px weight 500, color `#8b8b8f`
- CTA button (right): background `#0666eb`, color white

### Data Card / Metric Display

Create a metric card with Revolut visual identity:
- Background: `#1a1a1a`
- Border-radius: 8px, padding 32px
- Metric: 32px weight 600, color `#ffffff`
- Label: 14px weight 400, color `#8b8b8f`

### Brand-Specific Component

Create a component showcasing Revolut's distinctive design pattern:
- Reflect the brand's dark-fintech characteristic
- Use accent color `#0666eb` sparingly for high-signal moments
...
2. **Accent color is for high-signal moments only.** `#0666eb` appears on CTAs and key interactive elements. Never use it as a decorative surface fill.
...
6. **Every component should feel unmistakably Revolut.** The dark-fintech aesthetic is the brand's signature.
