...
Aesthetic: digital editorial with chiaroscuro drama.
...
- Subtitle: 20px, weight 400, line-height 1.50, color `#666666`, max-width 600px, margin-top 16px
- CTA button: background `#da291c`, color `#000000`, 16px weight 500, padding 12px 24px, border-radius 8px
...
- Description: 16px, weight 400, line-height 1.50, color `#666666`
...
- Primary: background `#da291c`, color `#000000`, padding 12px 24px, border-radius 8px
- Secondary: background transparent, border 1px solid `#da291c`, color `#da291c`, padding 12px 24px, border-radius 8px
...
- Nav links: 14px weight 500, color `#666666`
- CTA button (right): background `#da291c`, color white

### Data Card / Metric Display

Create a metric card with Ferrari visual identity:
- Background: `#1a1a1a`
- Border-radius: 8px, padding 32px
- Metric: 32px weight 600, color `#ffffff`
- Label: 14px weight 400, color `#666666`

### Brand-Specific Component

Create a component showcasing Ferrari's distinctive design pattern:
- Reflect the brand's chiaroscuro-layout characteristic
- Use accent color `#da291c` sparingly for high-signal moments
...
2. **Accent color is for high-signal moments only.** `#da291c` appears on CTAs and key interactive elements. Never use it as a decorative surface fill.
...
6. **Every component should feel unmistakably Ferrari.** The chiaroscuro-layout aesthetic is the brand's signature.
