# Calcom -- Agent Prompt Guide

Self-contained reference for generating pixel-perfect Calcom-branded components.
Aesthetic: scheduling with dark professional interface.
...
Create a hero section with Calcom visual identity:
...
Create a feature card with Calcom visual identity:
- Background: `#1a1a1a`
- Border-radius: 8px
- Padding: 32px
...
Create a CTA button row with Calcom visual identity:
...
Create a navigation bar with Calcom visual identity:
...
Create a metric card with Calcom visual identity:
- Background: `#1a1a1a`
...
Create a component showcasing Calcom's distinctive design pattern:
- Reflect the brand's dark-scheduling characteristic
...
6. **Every component should feel unmistakably Calcom.** The dark-scheduling aesthetic is the brand's signature.
