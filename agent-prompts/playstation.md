# Playstation -- Agent Prompt Guide

Self-contained reference for generating pixel-perfect Playstation-branded components.
Aesthetic: dark gaming with blue brand accent.
...
Create a hero section with Playstation visual identity:
...
- CTA button: background `#006fcd`, color `#000000`, 16px weight 500, padding 12px 24px, border-radius 8px
- On mobile (<640px): headline 32px, padding 48px 20px

### Feature Card

Create a feature card with Playstation visual identity:
- Background: `#1a1a1a`
- Border-radius: 8px
- Padding: 32px
...
Create a CTA button row with Playstation visual identity:
- Layout: flex, gap 12px
- Primary: background `#006fcd`, color `#000000`, padding 12px 24px, border-radius 8px
- Secondary: background transparent, border 1px solid `#006fcd`, color `#006fcd`, padding 12px 24px, border-radius 8px
- On mobile (<640px): stack full-width

### Navigation Bar

Create a navigation bar with Playstation visual identity:
...
- CTA button (right): background `#006fcd`, color white

### Data Card / Metric Display

Create a metric card with Playstation visual identity:
- Background: `#1a1a1a`
...
Create a component showcasing Playstation's distinctive design pattern:
- Reflect the brand's dark-gaming characteristic
- Use accent color `#006fcd` sparingly for high-signal moments
...
2. **Accent color is for high-signal moments only.** `#006fcd` appears on CTAs and key interactive elements. Never use it as a decorative surface fill.
...
6. **Every component should feel unmistakably Playstation.** The dark-gaming aesthetic is the brand's signature.
