# Ollama -- Agent Prompt Guide

Self-contained reference for generating pixel-perfect Ollama-branded components.
Aesthetic: local AI with friendly terminal aesthetic.
...
Create a hero section with Ollama visual identity:
- Background: `#1a1a1a` (dark immersive surface)
...
Create a feature card with Ollama visual identity:
- Background: `#1a1a1a`
- Border-radius: 8px
- Padding: 32px
...
Create a CTA button row with Ollama visual identity:
...
Create a navigation bar with Ollama visual identity:
...
Create a metric card with Ollama visual identity:
- Background: `#1a1a1a`
...
Create a component showcasing Ollama's distinctive design pattern:
- Reflect the brand's terminal-friendly characteristic
...
6. **Every component should feel unmistakably Ollama.** The terminal-friendly aesthetic is the brand's signature.
