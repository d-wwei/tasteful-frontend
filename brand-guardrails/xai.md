# Xai -- Design Guardrails

## Do's (10 items)

1. **Use `#000000` as the primary page background.** This is the foundation of the Xai visual identity. Verify: page background matches this value.
...
7. **Apply appropriate border-radius for the brand.** Xai's geometry is rounded and approachable.
