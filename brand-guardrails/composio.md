# Composio -- Design Guardrails

## Do's (10 items)

1. **Use `#ffffff` as the primary page background.** This is the foundation of the Composio visual identity. Verify: page background matches this value.
...
7. **Apply appropriate border-radius for the brand.** Composio's geometry is rounded and approachable.
