# Resend -- Design Guardrails

## Do's (10 items)

1. **Use `#000000` as the primary page background.** This is the foundation of the Resend visual identity. Verify: page background matches this value.
...
4. **Use `#a1a1a1` for secondary and descriptive text.** Creates clear information hierarchy. Verify: metadata and descriptions use this muted tone.
...
7. **Apply appropriate border-radius for the brand.** Resend's geometry is rounded and approachable.
