# Ollama -- Design Guardrails

## Do's (10 items)

1. **Use `#1a1a1a` as the primary page background.** This is the foundation of the Ollama visual identity. Verify: page background matches this value.
...
7. **Apply appropriate border-radius for the brand.** Ollama's geometry is rounded and approachable.
...
1. **Wrong background color.** Using white instead of `#1a1a1a` fundamentally changes the brand personality.
