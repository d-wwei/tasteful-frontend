# Calcom -- Design Guardrails

## Do's (10 items)

1. **Use `#0a0a0a` as the primary page background.** This is the foundation of the Calcom visual identity. Verify: page background matches this value.
...
7. **Apply appropriate border-radius for the brand.** Calcom's geometry is rounded and approachable.
